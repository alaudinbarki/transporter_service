          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text('تعديل من نحن في التطبيق', style: TextStyle(fontSize: 16, color: Colors.white),),
                ),
              ),
              Align(child: Text('من نحن', style: TextStyle(fontSize: 24, color: Color(0xff707070)),), alignment: Alignment.topRight,widthFactor: 4.3,),
              SizedBox(height: 5,),
              Container(
                height: 450,
                width: 300,
